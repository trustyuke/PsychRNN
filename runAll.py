...
noise_list = [0.5, 1, 1.5, 2, 2.2, 2.4, 2.6, 2.8, 3]
...
for id in range(len(noise_list)):
	...
	for round in range(10):
		...
		###################################################
		train_params['save_weights_path'] =  "./weights/basic2_recNoise" + str(network_params['rec_noise']) + "round" + str(round)
		...
		## save losses
		#####################################################
		loss_name = "./losses/basic2_recNoise" + str(network_params['rec_noise']) + "round" + str(round) + ".txt"
